...
export function setTileType(id, props) {
  TileTypes[id] = { ...(TileTypes[id] || {}), ...props };
}
export function getTileProps(id) {
  return TileTypes[id] || TileTypes[0];
}
export function isSolid(id) {
  return !!getTileProps(id).solid;
}
export function speedMulFor(id) {
  return getTileProps(id).speedMul ?? 1.0;
}
export function isLethal(id) {
  return !!getTileProps(id).lethal;
}
